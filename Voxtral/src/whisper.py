...
from src.config import SEED, TRAIN_DIR, VAL_DIR, WHISPER_HPARAMS, log
...
def evaluate(model_path_or_name: str, label: str, out_dir: Path) -> dict:
    ...
    # Lade Modell immer in float32 für Evaluation (verhindert dtype-Mismatch)
    ...
    for i, sample in enumerate(test_samples):
        ...
        # Sicherstellen dass Input immer float32 ist
...
def finetune(run_dir: Path) -> None:
    ...
    train_dataset = ASRDataset(TRAIN_DIR, processor)

"""
Pipeline: Whisper & Parakeet Evaluation + Fine-Tuning
...
Nutzung:
    python3 pipeline.py                   # Alle 6 Schritte
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Whisper & Parakeet Evaluation + Fine-Tuning Pipeline",
    )
    parser.add_argument(
        "--step", type=int, nargs="+", choices=[1, 2, 3, 4, 5, 6],
...
def main():
    ...
    log.info("Pipeline: Whisper & Parakeet Evaluation + Fine-Tuning")
    ...
    # File handler — full log saved in run directory
